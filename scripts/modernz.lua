...
local function osc_init()
    ...
    ne.eventresponder["mbtn_right_up"] = command_callback(user_opts.playlist_mbtn_left_command)
    ne.eventresponder["mbtn_left_up"] = command_callback(user_opts.playlist_mbtn_right_command)
